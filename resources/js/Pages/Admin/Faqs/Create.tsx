...
export default function Create() {
    ...
    return (
        <AdminLayout title="Tambah FAQ Baru">
            <Head title="Admin - Tambah FAQ" />
            ...
            <form onSubmit={handleSubmit} className="bg-surface-0 border border-cream-300/40 p-6 md:p-8 rounded-2xl shadow-sm space-y-6 max-w-3xl">
                <div>
                    <h2 className="text-lg font-bold text-ink-900 mb-1">Tambah FAQ Baru</h2>
                    <p className="text-xs text-navy-700">Buat pertanyaan dan jawaban dwibahasa untuk mempermudah calon mahasiswa.</p>
                </div>
                ...
                <div className="pt-4 border-t border-cream-300/40 flex justify-end space-x-3">
                    ...
                    >
                        ...
                        <span>{processing ? 'Menyimpan...' : 'Simpan FAQ'}</span>
                    </button>
                </div>
            </form>
        </AdminLayout>
