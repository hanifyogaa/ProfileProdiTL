...
export default function Edit({ stat }: EditProps) {
    ...
    return (
        <AdminLayout title="Edit Statistik">
            <Head title="Admin - Edit Statistik" />
            ...
            <form onSubmit={handleSubmit} className="bg-surface-0 border border-cream-300/40 p-6 md:p-8 rounded-2xl shadow-sm space-y-6 max-w-2xl">
                <div>
                    <h2 className="text-lg font-bold text-ink-900 mb-1">Edit Statistik</h2>
                    <p className="text-xs text-navy-700">Perbarui nilai atau keterangan statistik di bawah ini.</p>
                </div>
                ...
                <div className="pt-4 border-t border-cream-300/40 flex justify-end space-x-3">
                    ...
                    >
                        ...
                        <span>{processing ? 'Menyimpan...' : 'Perbarui Statistik'}</span>
                    </button>
                </div>
            </form>
        </AdminLayout>
