...
export default function Create() {
    const { data, setData, post, processing, errors } = useForm({
        title_id: '',
        title_en: '',
        level: 'national' as 'national' | 'international',
        date: '',
        holder: '',
        category: '',
        description_id: '',
    ...
    return (
        <AdminLayout title="Tambah Prestasi Baru">
            ...
            <form onSubmit={handleSubmit} className="max-w-3xl space-y-6 rounded-2xl border border-cream-300/40 bg-surface-0 p-6 shadow-sm md:p-8">
                <div>
                    <h2 className="text-lg font-bold text-ink-900">Tambah Prestasi</h2>
                    <p className="mt-0.5 text-xs text-navy-700">Catat prestasi mahasiswa atau dosen untuk dipajang di halaman pencapaian.</p>
                </div>
                ...
                <div className="space-y-1">
                    ...
                    <input
                        ...
                        placeholder="Tim Nawasena / Nama Mahasiswa / Nama Dosen"
                        className="w-full rounded-xl border border-cream-300 bg-surface-0 px-4 py-2.5 text-sm outline-none focus:border-brand-700 focus:ring-2 focus:ring-brand-700/10"
                        required
                    />
